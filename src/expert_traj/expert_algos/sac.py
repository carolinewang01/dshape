# from stable baselines version 2.10
# slight modification to the way callbacks are initialized, random seeds are set, model saving at end of train
import os
import time
import warnings
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for step in range(total_timesteps):
                ...
                if self.num_timesteps < self.learning_starts or np.random.rand() < self.random_exploration:
                    ...
                    action = self.policy_tf.step(obs[None], deterministic=self.deterministic_policy).flatten()
